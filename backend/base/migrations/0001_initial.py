# Generated by Django 3.0 on 2020-04-15 18:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=20, null=True)),
                ('users', models.ManyToManyField(to=settings.AUTH_USER_MODEL)),
                ('wallet', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='base.Wallet', to_field='uuid')),
            ],
        ),
        migrations.CreateModel(
            name='Note',
